export const sprites = [
  ...
  {
    src:
      'data:image/svg+xml;base64,PHN2ZyB3aWR0aD0iMTIiIGhlaWdodD0iMTgiIHZpZXdCb3g9IjAgMCAxMiAxOCIgZmlsbD0ibm9u%0D%0AZSIgeG1sbnM9Imh0dHA6Ly93d3cudzMub3JnLzIwMDAvc3ZnIj4KPHJlY3Qgd2lkdGg9IjEyIiBo%0D%0AZWlnaHQ9IjE4IiBmaWxsPSIjNUE3RkZGIi8+Cjwvc3ZnPgo=',
    width: 12,
    height: 18,
  ...
  {
    src:
      'data:image/svg+xml;base64,PHN2ZyB3aWR0aD0iMTYiIGhlaWdodD0iMTYiIHZpZXdCb3g9IjAgMCAxNiAxNiIgZmlsbD0ibm9u%0D%0AZSIgeG1sbnM9Imh0dHA6Ly93d3cudzMub3JnLzIwMDAvc3ZnIj4KPGNpcmNsZSBjeD0iOCIgY3k9%0D%0AIjgiIHI9IjgiIGZpbGw9IiNGRjQwMkUiLz4KPC9zdmc+Cg==',
    width: 16,
    height: 16,
...
export const faces = [
  {
    src:
      `${process.env.PUBLIC_URL}/photos/mini-eric-glab.png`,
    width: 5,
    height: 5,
    airFrictionMultiplier: 0.75,
  },
  ...
  {
    src:
    `${process.env.PUBLIC_URL}/photos/mini-kevin-glab.png`,
    width: 5,
    height: 5,
    airFrictionMultiplier: 0.9,
  },
  {
    src:
    `${process.env.PUBLIC_URL}/photos/mini-maxime-glab.png`,
    width: 5,
    height: 5,
    airFrictionMultiplier: 1,
  },
  {
    src:
    `${process.env.PUBLIC_URL}/photos/mini-victor-glab.png`,
    width: 5,
    height: 5,
    airFrictionMultiplier: 0.8,
  },
  {
    src:
      `${process.env.PUBLIC_URL}/photos/mini-jonathan-glab.png`,
    width: 5,
    height: 5,
    airFrictionMultiplier: 0.75,
  },
  ...
  {
    src:
      `${process.env.PUBLIC_URL}/photos/mini-jojo-glab.png`,
    width: 5,
    height: 5,
    airFrictionMultiplier: 0.75,
  },
